...
type
  ISteamClient009 = class
    ...
    function GetISteamGameServerStats(hSteamUser: HSteamUser; hSteamPipe: HSteamPipe; pchVersion: pAnsiChar): ISteamGameServerStats; virtual; abstract;
