...
type
  ISteamMatchmaking008 = class (TObject)
    ...
    *)
    ...
    procedure AddRequestLobbyListDistanceFilter(eLobbyDistanceFilter: ELobbyDistanceFilter); virtual; abstract;
