...
type
  CSteamInterface006 = class (TObject)
      ...
      function MountFilesystem(uAppId: LongWord; const szMountPath: pAnsiChar; var pError: TSteamError): SteamHandle_t; virtual; abstract;
      ...
      function OpenFileEx(const szFileName, szMode: pAnsiChar; iArg3: int; var puSize: uint32; var piArg5: int; var pError: TSteamError): SteamHandle_t; virtual; abstract;
      ...
      function GetAppUserDefinedRecord(uAppId: uint32; AddEntryToKeyValueFunc: KeyValueIteratorCallback_t;
       pvCKeyValue: Pointer; var pError: TSteamError): int; virtual; abstract;

      // ISteam006
      function FindServersNumServers(eSteamServerType:ESteamServerType): int; virtual; abstract;
      function FindServersIterateServer(eSteamServerType: ESteamServerType; uIndex: uint32;
       szServerAddress: pAnsiChar; iServerAddressChars: int): int; virtual; abstract;
      function FindServersGetErrorString(): pAnsiChar; virtual; abstract;
      function CheckAppOwnership(uAppId: uint32; var pbOwned: int; var pSteamGlobalUserID: TSteamGlobalUserID;
       var pError: TSteamError): int; virtual; abstract;
      function GetCachePercentFragmentation(uAppId: uint32; var puPercentFragmented: uint32;
       var pError: TSteamError): SteamCallHandle_t; virtual; abstract;
      function DefragCaches(uAppId: uint32; var pError: TSteamError): SteamCallHandle_t; virtual; abstract;
      function IsFileNeededByApp(uAppId: uint32; cszFileName: pAnsiChar; uArg1: uint32; var puArg2: uint32;
       var pError: TSteamError): int; virtual; abstract;

      function WaitForAppResources(uAppId: AppId_t; cszMasterList: pAnsiChar; var pError: TSteamError): SteamCallHandle_t; virtual; abstract;
      function ForceCellId(uCellId: CellID_t; var pError: TSteamError): int; virtual; abstract;
      function GetAppDLCStatus(nAppID: AppId_t; nDlcId: uint32; var pbOwned: int; var pError: TSteamError): int; virtual; abstract;
      function StartEngineEx(var pError: TSteamError; a1, a2: boolean): unknown_ret; virtual; abstract;
  end;
