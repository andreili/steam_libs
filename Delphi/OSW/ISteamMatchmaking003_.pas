...
type
  ISteamMatchmaking003 = class (TObject)
    ...
    *)
    ...
    function SetLobbyVoiceEnabled(steamIDLobby: CSteamID; bEnabled: boolean): unknown_ret; virtual; abstract;
