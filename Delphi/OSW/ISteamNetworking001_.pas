...
type
  ISteamNetworking001 = class (TObject)
    ...
    function CreateListenSocket(nVirtualP2PPort: int; nIP: uint32; nPort: uint16): SNetListenSocket_t; virtual; abstract;
    // creates a socket and begin connection to a remote destination
    // can connect via a known steamID (client or game server), or directly to an IP
    // on success will trigger a SocketStatusCallback_t callback
    // on failure or timeout will trigger a SocketStatusCallback_t callback with a failure code in m_eSNetSocketState
    function CreateP2PConnectionSocket(steamIDTarget: CSteamID; nVirtualPort, nTimeoutSec: int): SNetSocket_t; virtual; abstract;
    ...
    // returns false if no data is available
    // fills out *phSocket with the socket that data is available on
    function RetrieveData(hListenSocket: SNetListenSocket_t; pubDest: Pointer; cubDest: uint32; var cubMsgSize: uint32): bool; virtual; abstract;
    // returns information about the specified socket, filling out the contents of the pointers
    function GetSocketInfo(hSocket: SNetSocket_t; var pSteamIDRemote: CSteamID; var peSocketStatus: int; var punIPRemote: uint32; var unPortRemote: uint16): bool; virtual; abstract;
