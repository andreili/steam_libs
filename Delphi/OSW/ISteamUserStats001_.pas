...
type
  ISteamUserStats001 = class
    ...
    function GetNumGroupAchievements(gameID: CGameID): uint32; virtual; abstract;
    function GetGroupAchievementName(gameID: CGameID; iAchievement: uint32): pAnsiChar; virtual; abstract;
    ...
    function GetGroupAchievement(nGameID: CGameID; pchName: pAnsiChar; varpbAchieved: boolean; var a1: uint32): boolean; virtual; abstract;

    function SetAchievement(nGameID: CGameID; pchName: pAnsiChar): boolean; virtual; abstract;
    function SetGroupAchievement(nGameID: CGameID; pchName: pAnsiChar): boolean; virtual; abstract;

    // Store the current data on the server, will get a callback when set
    // And one callback for every new achievement
    function StoreStats(nGameID: CGameID): boolean; virtual; abstract;

    function ClearAchievement(gameID: CGameID; pchName: pAnsiChar): boolean; virtual; abstract;
    function ClearGroupAchievement(gameID: CGameID; pchName: pAnsiChar): boolean; virtual; abstract;
