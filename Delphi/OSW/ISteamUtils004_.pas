...
function ConverUtils004CppToI(Cpp: Pointer): ISteamUtils004;

implementation

function ConverUtils004CppToI(Cpp: Pointer): ISteamUtils004;
begin
  result:=ISteamUtils004.Create();
  result.fCpp:=Cpp;
end;

function ISteamUtils004.GetSecondsSinceAppActive(): uint32;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.GetSecondsSinceComputerActive(): uint32;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.GetConnectedUniverse(): EUniverse;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.GetServerRealTime(): RTime32;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.GetIPCountry(): pAnsiChar;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.GetImageSize(iImage: int; var pnWidth, pnHeight: uint32): boolean;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.GetImageRGBA(iImage: int; pubDest: puint8; nDestBufferSize: int): boolean;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.GetCSERIPPort(var unIP: uint32; var usPort: uint16): boolean;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.GetCurrentBatteryPower(): uint8;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.GetAppID(): AppId_t;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
procedure ISteamUtils004.SetOverlayNotificationPosition(eNotificationPosition: ENotificationPosition);
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.IsAPICallCompleted(hSteamAPICall: SteamAPICall_t; var pbFailed: boolean): boolean;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.GetAPICallFailureReason(hSteamAPICall: SteamAPICallCompleted_t): ESteamAPICallFailure;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.GetAPICallResult(hSteamAPICall: SteamAPICall_t; pCallback: Pointer; cubCallback,
...
procedure ISteamUtils004.RunFrame();
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.GetIPCCallCount(): uint32;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
procedure ISteamUtils004.SetWarningMessageHook(pFunction: SteamAPIWarningMessageHook_t);
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
...
function ISteamUtils004.IsOverlayEnabled(): boolean;
asm
  mov EAX, [EBP+$08]
  mov EAX, [EAX+$04]
  mov ECX, EAX
